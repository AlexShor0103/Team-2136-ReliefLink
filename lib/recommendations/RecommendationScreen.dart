      ...
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
          Padding(
            ...
            child: RecommendationButton(rec: recommendations[0])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[1])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[2])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[3])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[4])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[5])
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10), 
            child: RecommendationButton(rec: recommendations[6])
          ),
